...
"""
    ...
    parser.add_argument('-s', default='table.xlsx', dest='source',
                        help='source file (default: %(default)s)')
    parser.add_argument('-o', default='table.tex', dest='target',
                        help='target file (default: %(default)s)')
    parser.add_argument('--setting', default='setting.tex',
                        dest='setting', help='setting file (default: %(default)s)')
